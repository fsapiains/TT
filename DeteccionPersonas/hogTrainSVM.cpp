...
//void getSupportVector(const CvSVM & svm, vector<float> & support_vector);
...
void PrimalSVM::getSupportVector(vector<float>& support_vector) const {
   int sv_count = get_support_vector_count();

   cout << "support v funcion" <<sv_count << endl;
   const CvSVMDecisionFunc* df= CvSVM::decision_func;
